...
def isProduct(str):
    list=[]
    file2list('/home/jinwei/PycharmProjects/bugzilla_web/bugapp/static/product_list',list)
    for l in list:
...
def isComponent(str):
    list = []
    file2list('/home/jinwei/PycharmProjects/bugzilla_web/bugapp/static/Component_list', list)
    for l in list:
        if (str == l.strip().strip("'")):
            return True
    return False
...
def sen2NLPatt(str):
    ...
    if 'name' in newstr:
        Bug_name_list = []
        file2list('/home/jinwei/PycharmProjects/bugzilla_web/bugapp/static/Bug_name_list', Bug_name_list)
    ...
    if 'product' in newstr:
        prodcut_list = []
        file2list('/home/jinwei/PycharmProjects/bugzilla_web/bugapp/static/product_list', prodcut_list)
    ...
    if 'component' in newstr:
        component_list = []
        file2list('/home/jinwei/PycharmProjects/bugzilla_web/bugapp/static/Component_list', component_list)
    ...
    if 'reported' in newstr:
        reported_list = []
        file2list('/home/jinwei/PycharmProjects/bugzilla_web/bugapp/static/Reported_time',reported_list)
    ...
    if 'modified' in newstr:
        modified_list = []
        file2list('/home/jinwei/PycharmProjects/bugzilla_web/bugapp/static/Modified_time',modified_list)
    ...
    if 'assignee' in newstr:
        Assignee_list = []
        file2list('/home/jinwei/PycharmProjects/bugzilla_web/bugapp/static/Assignee_list',Assignee_list)
    ...
    if 'reporter' in newstr:
        Reporter_list = []
        file2list('/home/jinwei/PycharmProjects/bugzilla_web/bugapp/static/Reporter_list',Reporter_list)
    ...
    if 'Triage Owner' in newstr:
        TriageOwner_list = []
        file2list('/home/jinwei/PycharmProjects/bugzilla_web/bugapp/static/TriageOwner_list',TriageOwner_list)
    ...
    if 'description' in newstr:
        Description_list = []
        file2list('/home/jinwei/PycharmProjects/bugzilla_web/bugapp/static/Description_list',Description_list)
...
def getTemplate_1(n):
    ...
    template.append(wh + mid + last)
    template.append('SELECT ?'+n.types[1]+' WHERE \n'+'{' +n.supp[0] + ' ' + getR(n)+' '+ '?' + n.types[1]+'}')
...
def getTemplate_0(n):
    ...
    last = ' ' + n.supp[1]
    template = []
    template.append(wh + mid + last + '<' + n.types[1] + '>')
    template.append('SELECT ?' + n.types[0] + ' WHERE \n' + '{?' + n.types[0] + ' ' + getR(n) + ' ' + n.supp[1] + '}')
    return template
